...
export default async function AboutPage({ searchParams }: AboutPageProps) {
  ...
  const stakeholderFallback = {
    ...
    desc: "Ibrahim Murtala Muhammad is a stakeholder engagement and programs professional with experience building strategic partnerships, leading multi-stakeholder initiatives, and driving programs that advance innovation, youth development, and sustainable development. He has successfully coordinated engagements across government institutions, development partners, the private sector, academia, and civil society to foster collaboration and deliver measurable impact.\n\nThroughout his career, Ibrahim has led partnership development, managed large-scale community and capacity-building programs, and contributed to initiatives that have empowered thousands of young people with digital and future-ready skills. His work spans program design and implementation, stakeholder mapping, policy dialogue, strategic communications, and ecosystem development, with a strong focus on creating sustainable partnerships that translate into meaningful outcomes.\n\nWith a background in engineering and expertise in technology, innovation, and development, Ibrahim brings a systems-thinking approach to solving complex challenges. He is passionate about convening diverse stakeholders, strengthening institutional collaboration, and designing programs that accelerate inclusive economic growth and social impact.",
  };
